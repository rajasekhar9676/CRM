...
import { Search, Edit, Save, X, User, Mail, Shield, Crown, RefreshCw } from 'lucide-react';
    ...
    try {
      ...
      if (userError || user?.role !== 'admin') {
        toast({
          ...
          description: "You need admin access to view this page. Redirecting to setup...",
          variant: "destructive",
        });
        router.push('/admin/setup-simple');
        return;
      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Button onClick={checkAdminAndFetchUsers} variant="outline" size="sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Edit user information, emails, names, and roles
            </CardDescription>
          </CardHeader>
          <CardContent>
